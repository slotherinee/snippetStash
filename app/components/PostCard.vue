<template>
  ...
  >
    ...
    <div class="flex flex-col flex-1 p-4">
      ...
      <!-- Footer -->
      <div
        class="flex items-center justify-between pt-3 mt-auto text-xs"
      ...
      >
        ...
        >
          <span
            class="w-5 h-5 rounded-full overflow-hidden flex-shrink-0 border border-surface-border"
          >
            <img
...
function formatDate(d: string) {
  return new Date(d).toLocaleDateString(locale.value === 'ru' ? 'ru-RU' : 'en-US', {
    month: 'short',
    day: 'numeric',
    year: 'numeric',
  })
